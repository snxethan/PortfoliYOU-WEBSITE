                   ...
                   <Notice />
                     <div className="flex flex-col items-center justify-center mt-12">
                         <div className="bg-[#222222] rounded-xl border border-[#333333] hover:border-red-600/50 p-6 lg:p-8 transition-transform duration-300 ease-out hover:scale-[1.03] active:scale-95 w-full max-w-md text-center shadow-xl">
                             ...
                             <h2 className="text-lg lg:text-xl font-semibold text-white mb-2">UNDER CONSTRUCTION</h2>
                             <p className="text-gray-400 text-sm lg:text-base mb-2">Check back soon!</p>
                             <button
                                 onClick={() => window.location.href = '/'}
                                 className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white rounded-lg gap-2 transition-all duration-200 ease-out hover:scale-105 active:scale-95 text-sm lg:text-base mt-4"
                             >
                                 View Portfoli-YOU
                             </button>
                         </div>
